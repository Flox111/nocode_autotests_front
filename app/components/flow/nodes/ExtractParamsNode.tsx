...
import { ExtractParamsConfig, PauseConfig } from "./nodes.config.";
import ExtractParamsDialog from "../../dialog/ExtractParamsDialog";
import { NodeContext } from "../../context";

const ExtractParamsNode = ({
  id,
  data,
}: {
...
export default memo(ExtractParamsNode);
